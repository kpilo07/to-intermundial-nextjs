...
export default async function LocalizedTotaltravelPage({ params }: { params: Promise<{ lang: string }> }) {
  const { lang } = await params;
  const cmsLang = LOCALE_TO_CMS_LANG[lang] ?? lang;
